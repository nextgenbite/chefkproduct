...
use App\Models\{Brand, Category, Color, Country, Page, Product, Setting, Slider, ShippingCost, Size};
...
class PublicController extends Controller
{
    ...
    public function contactStore(Request $request)
    {
        ...
        // Send the email
        Mail::to(Setting::where('skey', 'email')->first()->svalue)->send(new ContactMail($request->all()));
...
// return $request->all();
        // Send the email
        Mail::to(Setting::where('skey', 'email')->first()->svalue)->send(new PartnershipMail($request->all()));
