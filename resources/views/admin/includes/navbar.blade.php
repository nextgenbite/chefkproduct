    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="/admin" v-if="settings" class="flex ml-2 md:mr-24">
          ...
          <span
            class="self-center text-xl font-semibold uppercase sm:text-2xl whitespace-nowrap dark:text-white">{{isset($settings['app_name'])
            ? $settings['app_name'] : config('app.name')}}</span>
          @endisset
        </a>
        <a title="Visit Site" target="blank" href="/"
          class="text-gray-700  hidden  hover:bg-gray-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-1 text-center lg:inline-flex items-center dark:border-primary dark:text-gray-200 dark:hover:text-white dark:focus:ring-primary dark:hover:bg-primary">
      ...
      <div class="flex items-center">
        ...
        <button id="theme-toggle" type="button" class="text-gray-500 dark:text-yellow-300    rounded-lg text-sm p-2.5">
          <svg id="theme-toggle-dark-icon" class="hidden w-5 h-5 fa-beat" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
          </svg>
          <svg id="theme-toggle-light-icon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
        ...
        <div class="flex items-center ml-3">
          <div>
            <button type="button"
              ...
              <img class="w-8 h-8 rounded-full" src="{{ asset(auth()->user()->avatar ?: '/images/no-image.png') }}"
                alt="user photo" />
            </button>
          </div>
          <div
