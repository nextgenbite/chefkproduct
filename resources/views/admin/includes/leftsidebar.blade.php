          ...
          <ul class="space-y-2 font-medium">
              ...
              <li>
                  <button type="button"
                      ...
                      <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Users manage</span>
  ...
  <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                              ...
                              <span class="flex-1 ml-3 whitespace-nowrap">Customer List</span>
                          </a>
                      </li>
                  </ul>
              </li>
              <li>
                  <button type="button"
                      ...
                      <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Orders manage</span>
                      <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                          viewBox="0 0 10 6">
                          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="m1 1 4 4 4-4" />
  ...
  <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                  <button type="button"
                      ...
                      <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Product manage</span>
                      <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                          viewBox="0 0 10 6">
  ...
  <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Category List</span>
                        </a>
                    </li>
                    <li>
                        <a href="/admin/brands"
  ...
  <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap capitalize">Brand List</span>
                        </a>
                    </li>
                    <li>
                        <a href="/admin/products"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap capitalize">product List</span>
                        </a>
                    </li>
                  </ul>
              </li>
              ...
              <li>
                  <a href="/admin/sliders"
                      ...
                      <span class="flex-1 ml-3 whitespace-nowrap capitalize">Sliders manage</span>
                  </a>
              </li>
              <li>
                  <a href="/admin/pages"
                      ...
                      <span class="flex-1 ml-3 whitespace-nowrap capitalize">Page manage</span>
                  </a>
              </li>
              <li>
                  <button type="button"
