<aside id="logo-sidebar"
  ...
  <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
    <ul class="space-y-2 font-sans text-base ">
      ...
      <li>
        <button type="button"
          ...
          <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Administration</span>
      ...
      <li>
        <span class="ml-3 font-medium text-gray-600">Product Variant</span>
      </li>
      <li>
        <a href="/admin/brands"
          class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
      ...
      <li>
        <span class="ml-3 font-medium text-gray-600">Product Managment</span>
      </li>
      <li>
        <button type="button"
          class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          ...
          <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Categories</span>
          <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="m1 1 4 4 4-4" />
          </svg>
        </button>
        <ul id="dropdown-products" class="hidden py-2 space-y-2 text-sm">
          <li>
          ...
          <li>
            <a href="/admin/sub-categories"
              ...
              <span class="flex-1 ml-3 whitespace-nowrap capitalize">Sub Category</span>
            </a>
          </li>
      ...
      <li>
        <a href="/admin/products"
          ...
          <span class="flex-1 ml-3 whitespace-nowrap capitalize">products</span>
        </a>
      </li>
      <li>
        <button type="button"
          ...
          <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Orders</span>
          <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="m1 1 4 4 4-4" />
          </svg>
        </button>
        <ul id="dropdown-sales" class="hidden py-2 space-y-2 text-sm">
          <li>
            <a href="/admin/orders"
              class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
              <svg
      ...
      <li>
        <a href="/admin/sliders"
          ...
          <span class="flex-1 ml-3 whitespace-nowrap capitalize">Sliders</span>
        </a>
      </li>
      <li>
        <a href="/admin/pages"
          ...
          <svg
            class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none"
            viewBox="0 0 18 20">
          ...
          <span class="flex-1 ml-3 whitespace-nowrap capitalize">Pages</span>
        </a>
      </li>
      <li>
        <button type="button"
        ...
        <ul id="dropdown-Report" class="hidden py-2 space-y-2 text-sm">
          <li>
      ...
      <li>
        ...
        <ul id="dropdown-Settings" class="hidden py-2 space-y-2 text-sm">
          <li>
          ...
          <li>
            <a href="/admin/settings/plugins"
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Plugin Setup</span>
            </a>
          </li>
          <li>
      ...
      <li>
        <button type="button"
          ...
          <span class="flex-1 ml-3 text-left capitalize whitespace-nowrap">Test</span>
          <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="m1 1 4 4 4-4" />
          </svg>
        </button>
        <ul id="dropdown-test" class="hidden py-2 space-y-2 text-sm">
          <li>
            <a href="/admin/test/crud"
              class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
              <svg
                class="flex-shrink-0 w-3 h-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="sticky bottom-0 left-0 justify-center hidden w-full p-2 space-x-4 bg-white lg:flex dark:bg-gray-800"
      sidebar-bottom-menu>
      <a href="#"
      ...
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-layouts" class="hidden py-2 space-y-2 text-sm">
              <li>
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2 text-sm">
              <li>
                <a href=""
          ...
          <li>
            ...
            <ul id="dropdown-auth" class="hidden py-2 space-y-2 text-sm">
              <li>
                <a href=""
