                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                <img class="w-10 h-10 rounded-full" src="/images/users/{{ $item->avatar }}"
                                    alt="{{ $item->name }} avatar">
                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $item->name }}
                                    </div>
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">{{ $item->email }}
                                    </div>
                                </div>
                            </td>
                            <td
                            ...
                            <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    {{-- {{ if eq .status "Active" }} <div
                                        class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div> {{ else }} <div
                                        class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div> {{ end }} {{
                                    $item->status }} --}}
                                </div>
                            </td>
...
<section class="bg-gray-50 dark:bg-gray-900 p-3 ">
    <h3 class="text-lg md:text-2xl font-serif "> Categories</h3>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <th scope="row"
                                ...
                                <img class="w-10 h-10 rounded-full" src="{{asset($item->avatar)}}"
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button id="{{$item->name}}-dropdown-button" data-dropdown-toggle="{{$item->name}}-dropdown"
                                ...
                                <div id="{{$item->name}}-dropdown"
                                    ...
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a data-modal-target="editUserModal" data-modal-show="editUserModal"
                                                href="#"
