...
@section('hero')
    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td>
                <table class="pc-width-fill pc-w620-gridCollapsed-0" width="100%" border="0" cellpadding="0"
...
<img loading="lazy"
src="{{asset('assets/images/image-1719380710757.png')}}"
width="150"
height="162"
alt=""
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <div class="pc-font-alt pc-w620-fontSize-14px pc-w620-lineHeight-140pc"
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        style="letter-spacing: 0px;">You’ve
                                            ...
                                            <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px;">
                                                <table class="pc-width-fill pc-w620-gridCollapsed-0 pc-w620-width-fill"
                                                    ...
                                                    <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="bottom">
                                                                        <table align="center" width="100%"
                                                                                    ...
                                                                                    <table width="100%" border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                <img src="{{ asset('assets/images/5b305647c0f5e5a664d2cca777f34bf4.png') }}"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" valign="top">
                                                                                    <table class="pc-w620-width-auto"
                                                        ...
                                                        <td class="pc-w620-itemsSpacings-0-30" align="center"
                                                            valign="middle"
    ...
    <!--[if !gte mso 9]> -->
                                                        ...
                                                        <td class="pc-w620-itemsSpacings-0-30" align="center"
                                                            ...
                                                            <table
                                                                ...
                                                                cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td class="pc-w620-padding-0-6-0-6" align="center"
                                                                        valign="bottom">
                                                                        <table align="center" width="100%"
                                                                            border="0" cellpadding="0"
                                                                            cellspacing="0" role="presentation"
                                                                                    ...
                                                                                    <table width="100%" border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                valign="top"
                                                                                                style="padding: 0px 0px 12px 0px;">
                                                                                                <img src="{{ asset('assets/images/99e51c88245905d275cf11b1e90194ab.png') }}"
                                                                                                    class="pc-w620-width-38 pc-w620-height-auto"
                                                                                                    width="38"
                                                                                                    height="38"
                                                                                                    alt=""
                                                                                    ...
                                                                                    <table width="100%" border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                valign="top"
                                                                                                style="padding: 0px 0px 12px 0px;">
                                                                                                <img src="{{ asset('assets/images/7af250fce78f428f47ab75eeda734977.png') }}"
                                                                                                    class="pc-w620-width-38 pc-w620-height-auto"
                                                                                                    width="38"
                                                                                                    height="38"
                                                                                                    alt=""
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="pc-w620-padding-0-0-0-0"
                                                            ...
                                                            <div class="pc-font-alt pc-w620-fontSize-16px pc-w620-lineHeight-28"
                                                                style="line-height: 140%; letter-spacing: 0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; font-variant-ligatures: normal; color: #001942; text-align: center; text-align-last: center;">
                                                                <div><span style="letter-spacing: 0px;">Order
                                                                        number: #{{ $data->code }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 0px 0px 4px 0px; ">
                                                <table class="pc-w620-tableCollapsed-0" border="0" cellpadding="0"
                                                    cellspacing="0" role="presentation" width="100%" bgcolor="#FFFFFF"
                                                    style="border-collapse: separate; border-spacing: 0; width: 100%; background-color:#FFFFFF; border-radius: 10px 10px 10px 10px; overflow: hidden;">
                                                    <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td class="pc-w620-spacing-0-16-20-0"
                                                                                                                    ...
                                                                                                                    <img src="{{ asset($item->product->thumbnail) }}"
                                                                                                                        class="pc-w620-width-64 pc-w620-height-64 pc-w620-width-64-min"
                                                                                                                        width="100"
                                                                                                                        height="104"
                                                                                                                        alt=""
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" align="right">
                                                                                <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-20"
                                                                                    ...
                                                                                    <div><span
                                                                                            style="color: #001942;">{{ formatCurrency($item->total) }}</span>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="right">
                                                                            <div class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-20"
                                                                                ...
                                                                                <div>
                                                                                    <span>{{ formatCurrency($data->total + $data->tax  + $data->shipping_cost) }}</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding: 0px 0px 0px 0px;">
                                                <table class="pc-width-fill pc-w620-gridCollapsed-1" width="100%"
                                                    border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr class="pc-grid-tr-first pc-grid-tr-last">
                                                        <td class="pc-grid-td-first pc-w620-itemsSpacings-0-30"
