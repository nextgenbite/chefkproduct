...
<body class="min-h-screen bg-white dark:bg-gray-800 dark:text-white">
    ...
    <div
        ...
        <button ref="menuBar" @click="isMobileMenuOpen = true" id="menuBar"
    ...
    <div id="mobileMenu"
        class="fixed left-0 overflow-auto  top-0 w-full h-full z-50 bg-black bg-opacity-30 shadow hidden"
        id="mobileMenu">
