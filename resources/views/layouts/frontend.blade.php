...
<body class="min-h-screen bg-white dark:bg-slate-800 dark:text-white">
    <div id="content" style="display:none;">
        ...
        <div class=" fixed bottom-4 right-4 z-10">
            ...
            <a href="https://wa.me/+8801715808563" target="_blank" title="whatsapp" data-popover-target="popover-left" data-popover-placement="left" type="button" class=" text-primary-light hover:text-primary-light/90 font-medium rounded-lg text-sm text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><i style="font-size: 3rem" class="fab fa-whatsapp "></i></a>
            <div data-popover id="popover-left" role="tooltip" class="absolute z-10 invisible inline-block w-40 text-sm text-primary-light transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
    ...
    <script>
        ...
        src="https://www.facebook.com/tr?id={{isset($settings['pixel_id']) ?  $settings['pixel_id'] : null}}&ev=PageView&noscript=1"
        /></noscript>
    @endif
    <!-- End Meta Pixel Code -->
    @stack('scripts')
