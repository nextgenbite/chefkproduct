...
<div class="container py-4 flex justify-between ">
    <div class="flex gap-3 items-center ">
        ...
        <a href="{{ route('categories.show',$product->category->slug ) }}"
            class="text-primary-light font-medium  text-xs md:text-base capitalize">{{ $product->category->title }}</a>
        ...
        <div class="mt-4">
            ...
            <div class="relative flex items-center max-w-[3rem]">
                ...
                <input type="text" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation"
                    ...
                    class="bg-gray-50 border-x-0 border-gray-300 h-8 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-10 py-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    value="1" required />
