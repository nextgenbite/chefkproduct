    ...
    <form action="{{ url('/place-order') }}" method="post">
        ...
        <div class="container items-start grid-cols-12 gap-6 pt-4 pb-16 lg:grid ">
            ...
            <div
                ...
                <ul class="grid w-full gap-6 md:grid-cols-4 mb-2 text-center">
                    <li>
                        <input type="radio" name="payment_method" id="react-option" value="stripe" class="hidden peer"
                            required="">
                        <label for="react-option"
                            class="inline-flex lg:flex-col items-center justify-between w-full p-2 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-primary-light hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <div class="block">
                            ...
                            <i class="fa-brands fa-cc-stripe mb-1 text-3xl text-sky-500"></i>
                            <div class="w-full text-sm font-semibold">Strip</div>
                        </label>
                    </li>
                    <li>
                        ...
                        <label for="flowbite-option"
                            ...
                            <i class="fa-brands fa-paypal mb-1 text-3xl text-blue-800"></i>
                            <div class="w-full text-sm font-semibold">Paypal</div>
                        </label>
                    </li>
                    <li>
                        <input type="radio" name="payment_method" id="bkash-option" value="bkash" class="hidden peer">
                        <label for="bkash-option"
                            class="inline-flex lg:flex-col items-center justify-between w-full p-2 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700  peer-checked:border-primary-light hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <div class="block">
                                {{-- <svg class="mb-2 text-green-400 w-6 h-6" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M356.9 64.3H280l-56 88.6-48-88.6H0L224 448 448 64.3h-91.1zm-301.2 32h53.8L224 294.5 338.4 96.3h53.8L224 384.5 55.7 96.3z"/></svg> --}}
                            </div>
                            <img src="{{asset('/images/icons/bkash.png')}}" alt="bkash" class="rounded w-16 mb-1">
                            <div class="w-full text-sm font-semibold">Bkash</div>
                        </label>
                    </li>
                    <li>
                        ...
                        <label for="angular-option"
                            ...
                            <i class="fa-solid fa-money-bill mb-1 text-3xl text-green-500"></i>
                            <div class="w-full text-sm font-semibold">Cash On Delivary</div>
                        </label>
                    </li>
                </ul>
