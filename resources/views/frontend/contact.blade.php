...
@section('content')
    ...
    <!-- ---- Start Category  ----- -->
    <div class="mx-2 my-6 md:container lg:container">
        <!-- ====== Contact Section Start -->
        <section class="relative z-10 overflow-hidden bg-white dark:bg-dark py-2 lg:py-8 ">
            <div class="container mx-auto">
                <div class="flex flex-wrap -mx-4 lg:justify-between">
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div class="mb-12 max-w-[570px] lg:mb-0">
                            <span class="block mb-4 text-base font-semibold text-primary-light">
                                Contact Us
                            </span>
                            <h2
                                class="text-dark dark:text-white mb-6 text-2xl font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                            ...
                            <div class="mb-8 flex w-full max-w-[370px]">
                                <div
                                    class="bg-primary-light/5 text-primary-light mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]">
                        ...
                        <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                            <form action="{{ route('contact.store') }}" method="POST">
                                ...
                                <div class="mb-6">
                                    <input type="text" placeholder="Your Name" name="name"
                                        class="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary-light w-full rounded border py-3 px-[14px] text-base outline-none" />
                                        @if ($errors->has('name'))
                                ...
                                <div class="mb-6">
                                    <input type="email" placeholder="Your Email" name="email"
                                        ...
                                        @if ($errors->has('email'))
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                            <span class="font-medium">Oh, snap!</span> {{ $errors->first('email') }}
                                        </p>
                                    @endif
                                </div>
                                <div class="mb-6">
                                    <input type="text" placeholder="Your Phone" name="phone"
                                        ...
                                        @if ($errors->has('phone'))
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                            <span class="font-medium">Oh, snap!</span> {{ $errors->first('phone') }}
                                        </p>
                                    @endif
                                </div>
                                <div class="mb-6">
                                    <textarea rows="6" placeholder="Your Message" name="message"
                                        class="border-stroke dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color focus:border-primary-light w-full resize-none rounded border py-3 px-[14px] text-base outline-none"></textarea>
                                        @if ($errors->has('message'))
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                            <span class="font-medium">Oh, snap!</span> {{ $errors->first('message') }}
                                        </p>
                                    @endif
                                </div>
                                <div>
                                    <button type="submit"
                                        class="w-full p-3 text-white transition border rounded border-primary-light bg-primary-light hover:bg-opacity-90">
                                        Send Message
                                    </button>
                                </div>
                            </form>
                            <div>
                                <span class="absolute -top-10 -right-9 z-[-1]">
                                    <svg class="text-primary-light" width="100" height="100" viewBox="0 0 100 100" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
