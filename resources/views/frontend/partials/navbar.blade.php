         ...
         <div id="drawer-right-example"
             class="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full duration-300 bg-white w-72 dark:bg-gray-800"
             ...
             <div class="grid grid-cols-2 gap-4 mt-3 pt-4">
               <a href="#"
