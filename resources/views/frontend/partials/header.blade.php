    ...
    <header id="header"
        class="py-1 px-2 md:pt-2 shadow-sm space-x-2  bg-primary-light bg-opacity-20 lg:bg-white lg:dark:bg-gray-800  w-full top-0 right-0 left-0 z-50 container flex items-center justify-between">
