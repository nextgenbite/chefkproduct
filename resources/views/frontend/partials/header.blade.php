    ...
    <header id="header" class="py-1  md:pt-2 shadow-sm bg-primary lg:bg-white  w-full top-0 right-0 left-0 z-50">
        <div class="container flex items-center justify-between">
             ...
             <div class="w-full xl:max-w-xl lg:max-w-lg lg:flex relative  ">
                  ...
                  <input type="text" class=" border w-full md:max-lg:border-r-0 md:border-primary p-2 md:p-3 md:rounded-r-none rounded-md text-xs md:text-base  focus:ring-primary " placeholder="what are you looking for..." />
                  <button type="submit" title="search" class="lg:block hidden bg-primary border rounded-l-none border-primary text-white px-8 font-medium rounded-r-md hover:bg-transparent hover:text-primary transition  " >
                       <i class="fas fa-search"></i>
                  </button> 
   ...
   <ul class=" hidden w-full z-20 absolute top-full left-0 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <li class="w-full px-4 py-2 rounded-b-lg">Download</li>
             ...
             <div class="space-x-3 flex items-center">
                  <!-- <a title="title" href="#" class="md:block hidden text-center text-white md:text-gray-700 hover:text-primary transition relative " title="Account">
                       
                       <div class="text-xl lg:text-2xl ">
                            <i class="fas fa-user "></i> 
                       </div>
                  </a>  -->
                  <button type="button" class="hidden  text-primary border border-primary hover:bg-primary hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center lg:inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500">
                  ...
                  <a title="login" href="{{Route('login')}}" class=" text-gray-800 hover:text-secondary transition font-semibold hidden lg:inline" > Login  </a>
                  <a title="title" href="{{Route('register')}}" class=" text-gray-800 hover:text-secondary transition font-semibold hidden lg:inline" > | Register </a>
   <!-- 
                  <a title="title" href="#" class="md:block hidden text-center text-white md:text-gray-700 hover:text-primary transition relative " title="Cart">
